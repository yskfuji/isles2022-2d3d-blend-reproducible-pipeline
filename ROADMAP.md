...
- [ ] Per-fold validation summary table
- [ ] Static figures (architecture / repo map / metrics)

## Phase 3 — Distribution
- [ ] LinkedIn / X launch thread
- [ ] Qiita / Zenn article on MPS-compatible 3D nnU-Net workaround
- [ ] Track GitHub traffic post-publication
